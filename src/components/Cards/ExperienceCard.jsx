...
const Description = styled.div`
    ...
    color: ${({ theme }) => theme.text_primary + 'CC'}; /* Increased opacity for better visibility */
    line-height: 1.6; /* Added line spacing for readability */
    letter-spacing: 0.5px; /* Slight letter spacing for elegance */
    text-align: centre; /* Align text for a neat look */
    margin-top: 15px; /* Adjusted margin for better spacing */
    margin-bottom: 15px;
    @media only screen and (max-width: 768px) {
        font-size: 14px; /* Adjusted font size for smaller screens */
        line-height: 1.4; /* Adjusted line spacing for smaller screens */
    }
`;
